...
class Question1 extends Component{
    ...
    handleChange = (choosenAnswer) => {
        ...
        choosenAnswersArray[1]=choosenAnswer.target.value;
    ...
    render(){
      ...
      <Question>{this.state.questionName}</Question>
        <RadioGroup aria-label="question2" name="question2" value={choosenAnswer} onChange={this.handleChange}>
      ...
      <Button href="/thirdQuestion">Next
