...
class Question3 extends Component{
    ...
    handleChange = (choosenAnswer) => {
        ...
        choosenAnswersArray[2]=choosenAnswer.target.value;
    ...
    render(){
      ...
      <Question>{this.state.questionName}</Question>
        <RadioGroup aria-label="question3" name="question3" value={choosenAnswer} onChange={this.handleChange}>
      ...
      <Button href="/fourthQuestion">Next
