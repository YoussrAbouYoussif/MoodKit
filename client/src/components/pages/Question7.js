...
class Question7 extends Component{
    ...
    handleChange = (choosenAnswer) => {
        ...
        choosenAnswersArray[6]=choosenAnswer.target.value;
    ...
    render(){
      ...
      <Question>{this.state.questionName}</Question>
        <RadioGroup aria-label="question7" name="question7" value={choosenAnswer} onChange={this.handleChange}>
      ...
      <Button href="/eighthQuestion">Next
      <Link to={"/eighthQuestion" }>
            </Link>
      </Button>
        </div>
          )
