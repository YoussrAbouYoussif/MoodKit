...
class Question8 extends Component{
    ...
    handleChange = (choosenAnswer) => {
        ...
        choosenAnswersArray[7]=choosenAnswer.target.value;
    ...
    render(){
      ...
      <Question>{this.state.questionName}</Question>
        <RadioGroup aria-label="question8" name="question8" value={choosenAnswer} onChange={this.handleChange}>
      ...
      <Button href="/ninthQuestion">Next
      <Link to={"/ninthQuestion" }>
            </Link>
      </Button>
        </div>
          )
